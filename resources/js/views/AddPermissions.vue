        ...
        <div>
            <div class="w-full">
                <div class="w-full flex justify-around">
                    <label class="py-3 text-blue-500 font-bold mr-2">Modelo <span class="italic">(en singular)</span></label>
                    <input v-bind:disabled="!sendModel" type="text" id="model" class="form-input mt-1 block w-96 mr-2 uppercase" v-model="model" placeholder="venta" autofocus>
                    <button v-bind:disabled="loading" @click="addModel"
