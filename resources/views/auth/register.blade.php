...
<div class="mx-auto h-full flex justify-center items-center bg-gray-300">
    ...
    <svg class="fill-current text-white w-16" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
        ...
        <h2 class="text-white text-3xl pt-8">Join us</h2>
        ...
        <form method="POST" action="{{ route('register') }}" class="pt-8">
            ...
            <div class="relative pt-2">
                ...
                <div class="col-md-6">
                    <input id="name" type="text" class="pt-8 w-full rounded p-3 bg-blue-800 text-gray-300 outline-none focus:bg-blue-700" name="name" value="{{ old('name') }}" placeholder="Your name" autofocus>
                    @error('name')
            ...
            <div class="relative pt-2">
                ...
                <div class="col-md-6">
                    <input id="email" type="email" class="pt-8 w-full rounded p-3 bg-blue-800 text-gray-300 outline-none focus:bg-blue-700" name="email" value="{{ old('email') }}" placeholder="your@email.com">
            ...
            <div class="relative pt-2">
                ...
                <div class="col-md-6">
                    <input id="password" type="password" class="pt-8 w-full rounded p-3 bg-blue-800 text-gray-300 outline-none focus:bg-blue-700" name="password" placeholder="Password">
            ...
            <div class="relative pt-2">
                ...
                <div class="col-md-6">
                    <input id="password-confirm" type="password" class="pt-8 w-full rounded p-3 bg-blue-800 text-gray-300 outline-none focus:bg-blue-700" name="password_confirmation" placeholder="Repeat Password">
                </div>
            </div>

            <div class="pt-2">
                    <button type="submit" class="rounded w-full py-2 px-3 text-blue-800 text-left bg-gray-300 uppercase font-bold">
                        {{ __('Register') }}
                    </button>
            </div>
            <div class="pt-8 flex justify-between text-white text-sm font-bold">
                <a class="text-gray-300" href="{{ route('login') }}">
                    Login
                </a>
                <a class="text-gray-300" href="{{ route('register') }}">
                    Policies
                </a>
            </div>
        </form>
