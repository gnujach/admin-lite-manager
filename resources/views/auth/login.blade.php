    ...
    <div class="w-96 bg-blue-900 rounded-lg shadow-xl p-4">
        ...
        <form method="POST" action="{{ route('login') }}" class="pt-8">
            ...
            <div class="relative">
                ...
                <div class="">
                    <input id="email" type="email" class="pt-8 w-full rounded p-3 bg-blue-800 text-gray-300 outline-none focus:bg-blue-700" name="email" value="{{ old('email') }}" placeholder="you@email.com" autofocus>
                    @error('email')
